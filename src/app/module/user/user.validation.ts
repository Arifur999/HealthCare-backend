...
export const createDoctorZodSchema=z.object({
    ...
    doctor:z.object({
        ...
        currentWorkingPlace:z.string("Current working place is required").min(3,"Current working place must be at least 3 characters long").max(100,"Current working place must be at most 100 characters long"),
