...
router.patch("/change-appointment-status/:id", checkAuth(Role.DOCTOR, Role.ADMIN, Role.SUPER_ADMIN),AppointmentController.changeAppointmentStatus);
router.patch("/cancel-my-appointment/:id", checkAuth(Role.PATIENT), AppointmentController.cancelMyAppointment);
